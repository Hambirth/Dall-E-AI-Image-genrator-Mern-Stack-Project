  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]"> Create imaginative and visually stunning images generated by DALL-E 2.0 AI and share them with community</p>
      </div>
